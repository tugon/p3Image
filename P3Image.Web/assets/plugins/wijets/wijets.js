...
$.wijets = new function () {
		...
		onClick: function () {
			...
			if (controls) {
				controls.find('li span').bind('click', function (e) {
					...
					widget.removeClass('panel-default panel-bluegray panel-yellow panel-deeporange panel-lime panel-success panel-pink panel-deeppurple panel-green panel-info panel-teal panel-primary panel-warning panel-orange panel-danger panel-brown panel-magenta panel-purple panel-indigo panel-blue')
	...
	this.registerAction( {
	    ...
	    onClick: function () {
	        bootbox.alert("Coming Soon at Outline! Expand your panel to make it go fullscreen!")
	    }
	});
	...
	this.registerAction( {
	    ...
	    onClick: function () {
	        bootbox.alert("Coming Soon at Outline!")
	    }
	});
